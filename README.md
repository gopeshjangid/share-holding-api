...
This is a Verga Backend Api services. Using, Es6, mongoose, mongodb, node/expressjs.
...
| Auto server restart | Restart the server using [nodemon](https://github.com/remy/nodemon) in real-time anytime an edit is made, with babel compilation and eslint. yml |
...
```sh
git clone https://github.com/gopeshjangid/verga-backend.git
cd verga-backend
```
...
# Build docker
docker build -t varga-backend .

# Run docker
docker run -p 4040:4040 varga-backend
```
