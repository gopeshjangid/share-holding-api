...
class stripeClass {
    ...
    async checkout(params) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let domain = process.env.NODE_ENV === 'production' ? process.env.URL : 'https://myvarga.tech/dev';
    ...
    async membershipCheckout(params) {
        return new Promise(async (resolve, reject) => {
            try {
                let domain = process.env.NODE_ENV === 'production' ? process.env.URL : 'http://localhost:3000';
